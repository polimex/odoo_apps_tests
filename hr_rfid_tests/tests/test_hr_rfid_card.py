...
class CardTests(common.SavepointCase):
    ...
    def test_get_potential_access_doors(self):
        ...
        self.assertCountEqual(card.get_potential_access_doors(), potential_doors)

        card = create_card(env, '0000000002', self._contacts[2])
        ...
        self.assertCountEqual(card.get_potential_access_doors(self._acc_grs[3]), potential_doors)

        potential_doors = [ ]
        self.assertCountEqual(card.get_potential_access_doors(self._acc_grs[0]), potential_doors)
